...
import hcg from "../../assets/images/light.png";
            ...
            <div className="layout">
                <div className={`players_alive`}>
                    ...
                    <div className="counter_container">
                        <div
                            className={`team_counter ${left.side}`}>{leftPlayers.filter(player => player.state.health > 0).length}</div>
                        <div className={`vs_counter`}>VS</div>
                        <div
                            className={`team_counter ${right.side}`}>{rightPlayers.filter(player => player.state.health > 0).length}</div>
                    </div>
                </div>
                <Killfeed/>
                ...
                <div className={"boxes left"}>
                    ...
                    <div className='sidebox left'>
                        <div className="title_container">
                            <div className="title">HCG MASTERS</div>
                            <div className="subtitle">SEASON 1</div>
                        </div>
                        <div className="image_container">
                            <img src={hcg} id='image_left' alt='Left'/>
                        </div>
                    </div>
                    <MoneyBox
                        team={left.side}
                ...
                <div className={"boxes right"}>
                    ...
                    <div className={`sidebox right coalesce ${isFreezetime ? '' : 'hide'}`}>
                        <div className="title_container">
                            <div className="title">STRONGER TOGETHER WITH</div>
                            <div className="subtitle">COALESCE</div>
                        </div>
                        <div className="image_container">
                            <img src={coalesce} id='image_left' alt='Left'/>
                        </div>
                    </div>
